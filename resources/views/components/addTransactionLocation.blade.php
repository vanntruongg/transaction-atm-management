...
<div id="TransactionForm" class="hidden">
    <form method="POST" id="TransactionInfoForm" action="{{ url('create-transaction') }}">
        ...
        <input type="text" id="TransactionDiachi" name="PGD_DiaChi" required readonly class="w-full px-3 py-2 mb-4 border border-gray-300 rounded-lg bg-green-200">

        <label for="TransactionKinhDo" class="block mb-2">Kinh Độ Phòng Giao Dịch:</label>
        <input type="number" id="TransactionKinhDo" name="PGD_KinhDo" required readonly class="w-full px-3 py-2 mb-4 border border-gray-300 rounded-lg bg-green-200">

        <label for="TransactionViDo" class="block mb-2">Vĩ Độ Phòng Giao Dịch:</label>
        <input type="number" id="TransactionViDo" name="PGD_ViDo" required readonly class="w-full px-3 py-2 mb-4 border border-gray-300 rounded-lg bg-green-200">
