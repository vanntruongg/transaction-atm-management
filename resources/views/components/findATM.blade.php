<div id="searchBox" class="w-1/2 h-[200px] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 fixed bg-slate-100 text-center  rounded-md hidden">
    ...
    <label for="" class="block py-2">Khoảng Phí: 
        <label for=""><input type="range" class="inputRange mr-2" min="0" max="100000" ><output>0</output></label>
